insert into user (id, nome, email, password) values (1, 'Giancarlo', 'gian@local.com', '12345678');
insert into user (id, nome, email, password) values (2, 'Brendo', 'brendo@local.com', '12345678');
insert into user (id, nome, email, password) values (3, 'Paulo', 'paulo@local.com', '12345678');
